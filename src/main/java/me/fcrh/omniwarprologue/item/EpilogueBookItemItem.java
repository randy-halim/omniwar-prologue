...
import me.fcrh.omniwarprologue.gui.EpilogueGUIGuiWindow;
import me.fcrh.omniwarprologue.gui.EpilogueGUIGui;
...
public class EpilogueBookItemItem extends OmniwarPrologueModElements.ModElement {
	@ObjectHolder("omniwar_prologue:epilogue_book_item")
	public static final Item block = null;
	public EpilogueBookItemItem(OmniwarPrologueModElements instance) {
		super(instance, 49);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof EpilogueGUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(GlitchTabItemGroup.tab).maxStackSize(1).isImmuneToFire().rarity(Rarity.EPIC));
			setRegistryName("epilogue_book_item");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("The end to the beginning."));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("OmniWar: Prologue - Credits");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new EpilogueGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
