...
public class WaterArtifactItem extends OmniwarPrologueModElements.ModElement {
	@ObjectHolder("omniwar_prologue:water_artifact")
	public static final Item block = null;
	public WaterArtifactItem(OmniwarPrologueModElements instance) {
		super(instance, 25);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("water_artifact");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("The water in this bottle is as clear as the sky."));
