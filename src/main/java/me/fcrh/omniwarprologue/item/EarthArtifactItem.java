...
public class EarthArtifactItem extends OmniwarPrologueModElements.ModElement {
	@ObjectHolder("omniwar_prologue:earth_artifact")
	public static final Item block = null;
	public EarthArtifactItem(OmniwarPrologueModElements instance) {
		super(instance, 33);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("earth_artifact");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A sprout from the seeds of the earth, waiting to bloom as a new world."));
