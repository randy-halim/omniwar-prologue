...
public class AirArtifactItem extends OmniwarPrologueModElements.ModElement {
	@ObjectHolder("omniwar_prologue:air_artifact")
	public static final Item block = null;
	public AirArtifactItem(OmniwarPrologueModElements instance) {
		super(instance, 35);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("The manifestation of air itself."));
