...
package me.fcrh.omniwarprologue.world.biome;
...
public class NullPlainsBiome extends OmniwarPrologueModElements.ModElement {
	public static Biome biome;
	public NullPlainsBiome(OmniwarPrologueModElements instance) {
		super(instance, 4);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-10066330).setWaterColor(-16777216).setWaterFogColor(329011)
						...
						.setMoodSound(new MoodSoundAmbience((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
								.getValue(new ResourceLocation("block.respawn_anchor.charge")), 6000, 8, 2))
						.setMusic(new BackgroundMusicSelector((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
								.getValue(new ResourceLocation("ambient.crimson_forest.loop")), 12000, 24000, true))
						.build();
				...
				event.getRegistry().register(biome.setRegistryName("omniwar_prologue:null_plains"));
			}
		}
	}
	@Override
