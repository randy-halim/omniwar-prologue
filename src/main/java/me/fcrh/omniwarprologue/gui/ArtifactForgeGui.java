...
import me.fcrh.omniwarprologue.procedures.ArtifactForgeWhileThisGUIIsOpenTickProcedure;
...
public class ArtifactForgeGui extends OmniwarPrologueModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public ArtifactForgeGui(OmniwarPrologueModElements instance) {
		super(instance, 9);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("artifact_forge"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, ArtifactForgeGuiWindow::new));
	}
	...
	public void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.openContainer instanceof GuiContainerMod) {
			...
			double z = entity.getPosZ();
			{
				...
				ArtifactForgeWhileThisGUIIsOpenTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 43, 44) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (Items.DIAMOND_SWORD == stack.getItem());
				}
			}));
			...
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 133, 44) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				OmniwarPrologueMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
